...
状态：新任务从 2026-09-08 起按本文的形状写。**"老任务不迁"这条已于 2026-09-10 作废**——
判据改为"看迁移成本 + 以后的维护成本"，老方式耦合、改动影响大，成本可控就该迁，
见 `doc/full-audit-task-migration-design.md` §0。
...
| 4 | 迁移节奏 | ~~老任务不迁，只新任务用新形状~~ **2026-09-10 改为：按迁移成本+维护成本判，成本可控就迁** |
