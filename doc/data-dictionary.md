...
> 最后更新：2026-09-07（新增[数据起点](#数据起点每张表最早能有哪一天)、[抓取状态](#抓取状态)两节）。
...
| `Lhb` / `LhbSeat` | **2002-01-01** | 两所"公开信息制度"开始披露的年份（[SinaLhbProvider.cs:31](../src/StockPlatform.Data/Remote/SinaLhbProvider.cs#L31)）。⚠ 跟两融的 2010 无关，两者常被混为一谈 |
...
- **供应链网络**（要实体消歧，尚未做）：把对手名对到上市主体，连成买卖关系图
